...
```shell
git clone https://github.com/<your-name-here>/new-repository-test
cd new-repository-test
pnpm install
```
...
Note that [console-fail-test](https://github.com/RNR1/console-fail-test) is enabled for all test runs.
...
```shell
node ../new-repository-test/lib/hydrate/index.js -- description "Hooray, trying things out locally."
```
